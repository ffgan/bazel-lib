...
[expand_locations](https://github.com/ffgan/bazel-lib/blob/main/docs/expand_make_vars.md#expand_locations)
...
[expand_variables](https://github.com/ffgan/bazel-lib/blob/main/docs/expand_make_vars.md#expand_variables).
